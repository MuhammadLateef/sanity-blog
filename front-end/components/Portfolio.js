        ...
        />
          ...
          <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
            ...
            <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
              ...
              <Link href="#"><div className="buttons text-center md:text-left">
        ...
        <div className="mx-auto grid w-full grid-cols-1 gap-6 pt-12 sm:w-3/4 lg:w-full lg:grid-cols-3 xl:gap-10">
          ...
          {/* {blogs.map((item) => { 
            ...
            <div className="bg-white py-6 px-5 xl:py-8">
              <span className="block font-body text-lg font-semibold text-black"> Title</span>
              <span className="block pt-2 font-body text-grey-20">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore impedit aliquam sed error sapiente nihil commodi fuga saepe ratione? Veniam nemo possimus ipsa maxime fugit, odio deserunt perferendis illo in.</span>
            </div></div>
          </Link>
           })} */}
